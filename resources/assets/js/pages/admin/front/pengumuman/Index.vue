    ...
    <div class="container mb-8">
                ...
                <div class="card-body">
                    <form method="POST" @submit.prevent="send">
                        <div class="row">
                            ...
                            <div class="col-md-12 form-group">
                                <label>Konten</label>
                                <input type="text" class="form-control" v-model="formRequest.content">
                            </div>
                            <div class="col-md-12">
        ...
        <div class="card card-custom">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <mti-paginate url="/pengumuman/index" id="tableIndex" ref="tableIndex" classx="rounded table table-hover table-secondary" :columns="categoryColumns" classHead="pt-2" :callback="loadTable"></mti-paginate>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            send() {
                var vm = this;
                var url = '/pengumuman/create';
                if(vm.type != 'create') {
                    url = `/pengumuman/${vm.formRequest.uuid}/update`;
                }
