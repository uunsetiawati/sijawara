    ...
    <div class="container mb-8">
                    ...
                    <form method="POST" @submit.prevent="send">
                        <div class="row">
                            <div class="col-md-12 form-group">
                                ...
                                <input type="text" class="form-control" v-model="formRequest.nm_category">
                            </div>
                            <div class="col-md-12">
        ...
        <div class="card card-custom">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <mti-paginate url="/course/category/index" id="tableIndex" ref="tableIndex" classx="rounded table table-hover table-secondary" :columns="categoryColumns" classHead="pt-2" :callback="loadTable"></mti-paginate>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        data() {
            return {
                categoryColumns: [
                    ...
                    {name: 'Nama Kategori', data: 'nm_category'},
        ...
        methods: {
            ...
            send() {
                var vm = this;
                var url = '/course/category/create';
                if(vm.type != 'create') {
                    url = `/course/category/${vm.formRequest.uuid}/update`;
                }
