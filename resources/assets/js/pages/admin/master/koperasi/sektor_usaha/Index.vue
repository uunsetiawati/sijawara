    ...
    <div class="container mb-8">
        ...
        <div class="card card-custom">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <mti-paginate url="/sektor_usaha/index" id="tableIndex" ref="tableIndex" classx="rounded table table-hover table-secondary" :columns="categoryColumns" classHead="pt-2" :callback="loadTable"></mti-paginate>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            send() {
                var vm = this;
                var url = '/sektor_usaha/create';
                if(vm.type != 'create') {
                    url = `/sektor_usaha/${vm.formRequest.uuid}/update`;
                }
