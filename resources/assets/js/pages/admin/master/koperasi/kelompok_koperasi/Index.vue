    ...
    <div class="container mb-8">
        ...
        <div class="card card-custom">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <mti-paginate url="/kelompok_koperasi/index" id="tableIndex" ref="tableIndex" classx="rounded table table-hover table-secondary" :columns="categoryColumns" classHead="pt-2" :callback="loadTable"></mti-paginate>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            loadTable() {
                ...
                $('#tableIndex').on('click', '.delete', function(e) {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: (login) => {
                            return vm.$http({
                                url: `/kelompok_koperasi/${id}/delete`,
                                method: 'DELETE',
                            }).then((res) => {                
            ...
            send() {
                var vm = this;
                var url = '/kelompok_koperasi/create';
                if(vm.type != 'create') {
                    url = `/kelompok_koperasi/${vm.formRequest.uuid}/update`;
                }
