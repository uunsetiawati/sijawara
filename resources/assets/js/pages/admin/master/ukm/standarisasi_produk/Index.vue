    ...
    <div class="container mb-8">
        ...
        <div class="card card-custom">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <mti-paginate url="/standarisasi_produk/index" id="tableIndex" ref="tableIndex" classx="rounded table table-hover table-secondary" :columns="categoryColumns" classHead="pt-2" :callback="loadTable"></mti-paginate>
                    </div>
                </div>
            </div>
        </div>
    ...
    export default {
        ...
        methods: {
            loadTable() {
                ...
                $('#tableIndex').on('click', '.delete', function(e) {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: (login) => {
                            return vm.$http({
                                url: `/standarisasi_produk/${id}/delete`,
                                method: 'DELETE',
                            }).then((res) => {                
            ...
            getCategory(id, el) {
                ...
                KTApp.block(el);
                vm.$http({
                    url: `/standarisasi_produk/${id}/edit`,
                    method: 'GET',
                }).then((res) => {
                    KTUtil.scrollTop();
                    KTApp.unblock(el);
            ...
            send() {
                var vm = this;
                var url = '/standarisasi_produk/create';
                if(vm.type != 'create') {
                    url = `/standarisasi_produk/${vm.formRequest.uuid}/update`;
                }
