    ...
    <div class="container mb-8">
        ...
        <div class="card card-custom">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <mti-paginate url="/masalah_ukm/index" id="tableIndex" ref="tableIndex" classx="rounded table table-hover table-secondary" :columns="categoryColumns" classHead="pt-2" :callback="loadTable"></mti-paginate>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            send() {
                var vm = this;
                var url = '/masalah_ukm/create';
                if(vm.type != 'create') {
                    url = `/masalah_ukm/${vm.formRequest.uuid}/update`;
                }
