    ...
    <div class="container mb-8">
        ...
        <div class="card card-custom">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <mti-paginate url="/wilayah_pemasaran/index" id="tableIndex" ref="tableIndex" classx="rounded table table-hover table-secondary" :columns="categoryColumns" classHead="pt-2" :callback="loadTable"></mti-paginate>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            loadTable() {
                ...
                $('#tableIndex').on('click', '.delete', function(e) {
                    ...
                    Swal.fire({
                        ...
                        preConfirm: (login) => {
                            return vm.$http({
                                url: `/wilayah_pemasaran/${id}/delete`,
                                method: 'DELETE',
                            }).then((res) => {                
            ...
            send() {
                var vm = this;
                var url = '/wilayah_pemasaran/create';
                if(vm.type != 'create') {
                    url = `/wilayah_pemasaran/${vm.formRequest.uuid}/update`;
                }
