<template>
	<div
		:class="[{ 'card card-custom card-stretch gutter-b': useCard }, classHead]"
	>
		<div
			class="md-12 align-items-center"
			style="padding: 25px; padding-bottom: 0px"
			:class="{ 'p-0': !useCard }"
		>
			<div class="row">
				...
				<div
					class="col-md-4 kt-margin-b-20-tablet-and-mobile"
					style="margin-left: auto;"
				>
					<form
						:id="`searchBox` + id"
						@submit.prevent="reload(null, false)"
					...
					>
						<div class="input-icon input-icon-right">
							<input
								...
								placeholder="Search..."
							/>
							<span role="button" @click="reload(null, false)"
			...
			<div class="table-responsive">
				<table :id="id" :class="classx">
					<thead>
						<tr>
							<th
								:class="column.class ? column.class : false"
			...
			<div class="row">
				<div class="col-sm-12 col-md-5">
					<div
						...
						aria-live="polite"
					>
						Showing {{ paginate.from ? paginate.from : 0 }} to
						{{ paginate.to ? paginate.to : 0 }} of
							...
							<div v-for="nomor in nomors">
								<li
									:class="[
										...
										'page-item',
										{
											active: nomor.page == paginate.current_page ? 'true' : '',
										},
									]"
									v-on:click="reload(nomor.path)"
								>
									<a
										href="javascript:void(0)"
										class="page-link"
	...
	methods: {
		...
		reload(url = null, search = false) {
			...
			app
				...
				.then((res) => {
					KTApp.unblock("#" + app.id);
					$("#icon-search").removeClass(
						"kt-spinner kt-spinner--v2 kt-spinner--sm kt-spinner--success"
					);
